    ...
    return(
        ...
        className={cn(
            ...
            <SideBarLayout>
                ...
                {/* <BasicContainer/> */}
                <Image className="relative top-5 left-[420px] 3xl:left-[700px] h-[53px]" src="/images/Dashboard_title.png"
                              alt="dashboard_title"
                              width={252}
                              height={53}
                              priority={true}
                ...
                <div className="flex flex-col gap-6 py-6 h-full w-full mt-[150px] justify-center items-center">
                    ...
                    <p className="text-center w-[800px] 3xl:w-[1500px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi adipisci soluta dicta voluptatem quae corporis cum, dolorum accusantium tempora. Nemo provident maiores eaque dicta? Quae et atque fuga asperiores quia.</p>
                </div>
            </SideBarLayout>    
        </main>
    );
