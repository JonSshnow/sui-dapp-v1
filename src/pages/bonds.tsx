        ...
        className={cn(
            ...
            <SideBarLayout>
                ...
                <Image className="relative top-5 left-[450px] 3xl:left-[700px] h-[53px]" 
                    ...
                    priority={true}
                />                
                <div className="flex flex-col gap-6 py-6 h-full w-full 3xl:w-[1500px] mt-[150px] justify-center items-center">
                    ...
                    <div className="bg-[#666666] rounded-2xl max-w-6xl">
                        <div className="mx-auto w-[750px] 3xl:w-[1100px] max-w-7xl">
